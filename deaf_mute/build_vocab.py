...
from dataset import RecursiveCaptionDataset as RCDataset
######################################################""
import json
...
def main():
    ...
    word2idx_path = os.path.join(opt.cache, "word2idx.json")
    save_json(word2idx, word2idx_path, save_pretty=True)
    print("[Info] Finish.")

    vocab_glove_path = os.path.join(opt.cache, "vocab_glove.pt")
